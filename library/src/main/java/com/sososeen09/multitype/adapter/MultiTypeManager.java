...
import static com.sososeen09.multitype.adapter.Preconditions.checkNotNull;
 ...
 * @author drakeet
 */
public class MultiTypeManager implements TypeManager {
  ...
  /**
   * Constructs a MultiTypeManager with default lists.
   */
  ...
  /**
   * Constructs a MultiTypeManager with default lists and a specified initial capacity.
   *
   * @param initialCapacity the initial capacity of the list
   */
  public MultiTypeManager(int initialCapacity) {
  ...
  /**
   * Constructs a MultiTypeManager with specified lists.
   *
