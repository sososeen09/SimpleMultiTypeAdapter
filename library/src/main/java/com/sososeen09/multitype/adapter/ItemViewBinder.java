...
public abstract class ItemViewBinder<T, VH extends RecyclerView.ViewHolder> {
     ...
     * <p>
     * The payloads parameter is a merge list from {@link RecyclerView.Adapter#notifyItemChanged(int,
     * Object)} {@link RecyclerView.Adapter#notifyItemRangeChanged(int, int, Object)}.
