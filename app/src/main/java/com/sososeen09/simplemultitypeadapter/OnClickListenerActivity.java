    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baseMultiAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(OnClickAdapterContract adapter, View view, int position) {
                List<?> items = baseMultiAdapter.getItems();

                Object o = items.get(position);
                if (o instanceof Integer) {
                    Toast.makeText(OnClickListenerActivity.this, "this id Integer Type" + "--: " + position, Toast.LENGTH_SHORT).show();
                } else if (o instanceof String) {
                    Toast.makeText(OnClickListenerActivity.this, "this id String Type" + "--: " + position, Toast.LENGTH_SHORT).show();
                }
            }
        });
